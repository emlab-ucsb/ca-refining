...
calculate_mort_x_demg <- function(refining_mortality,
  ...
  ## save missing pop
  fwrite(missing_pop, file.path(main_path, "outputs/academic-out/refining/figures/2025-update/fig-csv-files/", "ct_missing_pop.csv"))
...
calc_cumul_av_mort <- function(main_path,
  ...
  ## save cumulative
  fwrite(dt, file.path(main_path, "outputs/academic-out/refining/figures/2025-update/fig-csv-files/", "cumulative_avoided_mortality.csv"))
...
calculate_county_health <- function( # health_weighted,
  ...
  fwrite(mort_df, file.path(main_path, "outputs/academic-out/refining/figures/2025-update/fig-csv-files/", "cumulative_health_x_county.csv"))

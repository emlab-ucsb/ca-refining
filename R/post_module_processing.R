...
combine_renewables_info_with_altair <- function(altair_ref, renewables_info) {
  ...
  renewables_info_altair = rbindlist(list(unique(altair_ref[, .(site_id, refinery_name, location, region, cluster)]),
...
gather_refinery_production <- function(ref_cons_prod, ei_crude, ei_gasoline, ei_diesel, ei_jet) {
  ...
  indiv_prod_1 = ref_cons_prod[, .(demand_scenario, refining_scenario, year,
  ...
  indiv_prod_1 =  melt(indiv_prod_1,
                       id.vars = c('demand_scenario', 'refining_scenario',  'year',
                                   'site_id', 'refinery_name', 'location', 'region'),
  ...
  indiv_prod_2 = ref_cons_prod[, .(demand_scenario, refining_scenario, 
  ...
  indiv_prod_2 =  melt(indiv_prod_2,
                       id.vars = c('demand_scenario', 'refining_scenario', 
                                   'site_id', 'refinery_name', 'location', 'region', 'year'),
...
gather_refinery_production_output <- function(indiv_prod) {
  ...
  indiv_prod_output = indiv_prod[, .(demand_scenario, refining_scenario, year,
  ...
  setcolorder(indiv_prod_output, c('demand_scenario', 'refining_scenario', 'year',
...
gather_refinery_production_output_bge <- function(indiv_prod) {
  ...
  indiv_prod_output_bge = indiv_prod[, .(demand_scenario, refining_scenario, year,
  ...
  setcolorder(indiv_prod_output_bge, c('demand_scenario', 'refining_scenario', 'year',
                                       'site_id', 'refinery_name', 'location', 'region', 'cluster', 'fuel', 'source', 'boundary', 'type', 'units', 'value'))
...
gather_refinery_crude_consumption <- function(ref_cons_prod, ei_crude, ei_gasoline, ei_diesel, ei_jet) {
  ...
  indiv_cons = ref_cons_prod[, .(demand_scenario, refining_scenario, year,
                                       site_id, refinery_name, location, region,
...
gather_refinery_crude_consumption_output <- function(indiv_cons) {
  indiv_cons_output = indiv_cons[, .(demand_scenario, refining_scenario, year,
  ...
  setcolorder(indiv_cons_output, c('demand_scenario', 'refining_scenario', 'year',
                                   'site_id', 'refinery_name', 'location', 'region', 'cluster', 'fuel', 'source', 'boundary', 'type', 'units', 'value'))
...
gather_refinery_crude_consumption_output_bge <- function(indiv_cons) {
  indiv_cons_output_bge = indiv_cons[, .(demand_scenario, refining_scenario, year,
  ...
  setcolorder(indiv_cons_output_bge, c('demand_scenario', 'refining_scenario', 'year',
                                       'site_id', 'refinery_name', 'location', 'region', 'cluster', 'fuel', 'source', 'boundary', 'type', 'units', 'value'))
...
gather_refinery_ghg <- function(ref_cons_prod, indiv_cons) {
  ...
  res = ref_cons_prod[, .(demand_scenario, refining_scenario, year, site_id, 
                          refinery_name, location, region, region_kgco2e_bbl)]
  
  # merge with consumption data to get refinery-emissions
  
  indiv_ghg = indiv_cons[res, on = .(demand_scenario, refining_scenario, year,
                                     site_id, refinery_name, location, region)]
...
gather_refinery_ghg_output <- function(indiv_ghg) {
  ...
  indiv_ghg_output = indiv_ghg[, .(demand_scenario, refining_scenario, year,
                                   site_id, refinery_name, location, region, 
  ...
  setcolorder(indiv_ghg_output, c('demand_scenario', 'refining_scenario', 'year',
                                  'site_id', 'refinery_name', 'location', 'region', 
...
gather_cluster_prod_output <- function(indiv_prod_output) {
  ...
  clus_prod_output = indiv_prod_output[, .(value = sum(value, na.rm = T)),
                                       by = .(demand_scenario, refining_scenario, cluster, 

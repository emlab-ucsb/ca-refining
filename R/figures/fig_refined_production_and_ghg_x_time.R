...
plot_refined_products_and_ghg <- function(tot_fuel_demand_exports, state_ghg_output) {
  ...
  prod_data[, refining_scenario := factor(refining_scenario, levels = c('historic production',
                                                                        'historic exports',
                                                                        'low exports'))]
  ghg_data[, refining_scenario := factor(refining_scenario, levels = c('historic production',
                                                                       'historic exports',
                                                                       'low exports'))]

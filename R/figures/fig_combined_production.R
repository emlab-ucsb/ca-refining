...
#   ghg_data = state_ghg_data[source == "total" & boundary == "complete"]
...
#   
#   ## factor fuel
#   prod_data[, fuel_adj := factor(fuel_adj, levels = rev(c('Gasoline',
#                                                           'Renewable Gasoline',
#                                                           'Diesel',
#                                                           'Renewable Diesel',
#                                                           'Jet Fuel',
...
#   prod_data[, refining_scenario_adj := factor(refining_scenario_adj, levels = c('Historic Production',
#                                                                                 'Historic Exports',
#                                                                                 'Low Exports'))]
#   ghg_data[, refining_scenario_adj := factor(refining_scenario_adj, levels = c('Historic Production',
#                                                                                'Historic Exports',
#                                                                                'Low Exports'))]
#   
...
#     geom_area(data = prod_data[demand_scenario_adj == 'Reference Demand' & refining_scenario_adj == 'Historic Production'], 
#               aes(x = year, y = consumption_bge / 1e6, fill = fuel_adj)) +
#     geom_line(data = ghg_data[demand_scenario_adj == 'Reference Demand' & refining_scenario_adj == 'Historic Production'], 
...
#     scale_y_continuous(name = 'Fuel production\n(Million bge)',
...
#     geom_area(data = prod_data[demand_scenario_adj == 'Reference Demand' & refining_scenario_adj == 'Historic Exports'], 
#               aes(x = year, y = consumption_bge / 1e6, fill = fuel_adj)) +
#     geom_line(data = ghg_data[demand_scenario_adj == 'Reference Demand' & refining_scenario_adj == 'Historic Exports'], 
#               aes(x = year, y = ghg_MtCO2 * coef, color = label), linewidth = 1.3) +
#     geom_vline(xintercept=2020, linetype = 'dashed', color = 'black', linewidth = 1) +
#     labs(title = 'Reference Demand\nHistoric Exports',
#          x = NULL,
...
#   
#   f_ref_lowexp = ggplot() +
#     geom_area(data = prod_data[demand_scenario_adj == 'Reference Demand' & refining_scenario_adj == 'Low Exports'], 
#               aes(x = year, y = consumption_bge / 1e6, fill = fuel_adj)) +
#     geom_line(data = ghg_data[demand_scenario_adj == 'Reference Demand' & refining_scenario_adj == 'Low Exports'], 
#               aes(x = year, y = ghg_MtCO2 * coef, color = label), linewidth = 1.3) +
#     geom_vline(xintercept=2020, linetype = 'dashed', color = 'black', linewidth = 1) +
#     labs(title = 'Reference Demand\nLow Exports',
#          x = NULL,
...
#     geom_area(data = prod_data[demand_scenario_adj == 'Low Carbon Demand' & refining_scenario_adj == 'Historic Production'], 
#               aes(x = year, y = consumption_bge / 1e6, fill = fuel_adj)) +
#     geom_line(data = ghg_data[demand_scenario_adj == 'Low Carbon Demand' & refining_scenario_adj == 'Historic Production'], 
#               aes(x = year, y = ghg_MtCO2 * coef, color = label), linewidth = 1.3) +
#     geom_vline(xintercept=2020, linetype = 'dashed', color = 'black', linewidth = 1) +
#     labs(title = 'Low Carbon Demand\nHistoric Production',
#          x = NULL,
...
#   
#   f_lc_histexp = ggplot() +
#     geom_area(data = prod_data[demand_scenario_adj == 'Low Carbon Demand' & refining_scenario_adj == 'Historic Exports'], 
#               aes(x = year, y = consumption_bge / 1e6, fill = fuel_adj)) +
#     geom_line(data = ghg_data[demand_scenario_adj == 'Low Carbon Demand' & refining_scenario_adj == 'Historic Exports'], 
#               aes(x = year, y = ghg_MtCO2 * coef, color = label), linewidth = 1.3) +
#     geom_vline(xintercept=2020, linetype = 'dashed', color = 'black', linewidth = 1) +
#     labs(title = 'Low Carbon Demand\nHistoric Exports',
#          x = NULL,
...
#   
#   f_lc_lowexp = ggplot() +
#     geom_area(data = prod_data[demand_scenario_adj == 'Low Carbon Demand' & refining_scenario_adj == 'Low Exports'], 
#               aes(x = year, y = consumption_bge / 1e6, fill = fuel_adj)) +
#     geom_line(data = ghg_data[demand_scenario_adj == 'Low Carbon Demand' & refining_scenario_adj == 'Low Exports'], 
#               aes(x = year, y = ghg_MtCO2 * coef, color = label), linewidth = 1.3) +
#     geom_vline(xintercept=2020, linetype = 'dashed', color = 'black', linewidth = 1) +
#     labs(title = 'Low Carbon Demand\nLow Exports',
#          x = NULL,

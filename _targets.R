...
list(
  ...
  tar_target(name = save_ct_xwalk, 
             command = simple_fwrite(ct_xwalk, main_path, "outputs/refining-2023/health-prev-inputs", "ct_xwalk_2019_2020.csv"), 
             format = "file"),
  tar_target(name = save_health_income, 
             command = simple_fwrite(refining_health_income, main_path, "outputs/refining-2023/health-prev-inputs", "refining_health_income_2023.csv"), 
             format = "file"),
  tar_target(name = save_health_income_2000, 
             command = simple_fwrite(health_weighted, main_path, "outputs/refining-2023/health-prev-inputs", "refining_health_census_tract.csv"), 
             format = "file"),
  tar_target(name = save_mortality,
             command = simple_fwrite(refining_mortality, main_path, "outputs/refining-2023/health-prev-inputs", "refining_mortality_2023.csv"),
             format = "file"),
  ...
  tar_target(name = save_fig_demand,
             command = simple_ggsave(fig_demand, 
                                     main_path, 
                                     "outputs/academic-out/refining/figures/2022-12-update/prev-inputs",

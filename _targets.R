...
list(
  ...
  # list save paths
  tar_target(name = list_save_paths, c(
    "revision-main" = file.path("outputs", "academic-out", "refining", "figures", "2025-revision-main"
  ))),
  ...
  # create folders
  tar_target(name = save_folders, command = create_save_folders(main_path,
                                                                save_path)),
